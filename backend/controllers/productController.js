...
const getAllProducts = async (req, res) => {
    try {
        ...
        const productsList = await products.find(query, null, options)
        ...
        const productsWithVariants = productsList.map(product => ({
            ...product.toObject(),
            variants: variantAll.filter(variant => variant.productId.equals(product._id))
        }));
